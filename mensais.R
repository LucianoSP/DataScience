...
inicio = format(floor_date(dmy(inicio), 'month'), "%d/%m/%Y")
fim <- format(hoje, "%d/%m/%Y")

# Series Mensais
dados1 = ler(3, 5, 390, 2, 3)
dados2 = ler(3, 5, 390, 4, 5)
dados3 = ler(3, 5, 390, 6, 7)
dados4 = ler(3, 5, 390, 8, 9)
dados5 = ler(3, 5, 390, 10, 11)
dados6 = ler(3, 5, 390, 12, 13)
dados7 = ler(3, 5, 390, 14, 15)
dados8 = ler(3, 5, 390, 16, 17)
dados9 = ler(3, 5, 390, 18, 19)
dados10 = ler(3, 5, 390, 20, 21)
dados11 = ler(3, 5, 390, 22, 23)
...
lista_delete = paste0("DELETE FROM ", tabela," WHERE atualizada >= '", dmy(inicio), 
